...
public class Amount {
    ...
    public static final String MESSAGE_CONSTRAINTS = "Amount should not be blank, may"
        + " contain numbers, up to 12 digits and 2 decimal places. No currency prefix is needed and"
